	...
	<div v-for="(slide, i) in slides" :class="checkActive(i)" id="home" class="jumboBox mb-3 slide">
		<div class="row align-items-center mx-0 overflow-hidden">
			<div class="col-5 position-relative">
				...
				<span class="carouselBtn position-absolute z-3">
					<button class="btn rounded-circle" @click="prev()">
						<i class="fa-sharp fa-solid fa-caret-left fs-3"></i>
					</button>
					<button class="btn rounded-circle ms-3" @click="next()">
						<i class="fa-sharp fa-solid fa-caret-right fs-3"></i>
					</button>
				</span>
			</div>
